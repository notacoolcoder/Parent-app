        ...
        <div className="homeMainDiv">
          ...
          <div style={{height : "45vh" , width : "360px", maxWidth : "90%" , backgroundColor : "#2B2082" , display : "flex" , justifyContent : "space-around" ,flexDirection : "column"}}>
            <div style={{height : "27.5vh" , width : "inherit" , display : "flex" , flexDirection : "row" , justifyContent : "space-around" , alignItems : "center"}}>
              ...
              <div style={{color:"white",textAlign:"center",}}><div style={{height : "80px" , width : "80px" , backgroundColor : "#FD0041" , display : "flex" , alignItems :"center" , justifyContent : "center" , borderRadius : "40px"}}><Icon style={{fontSize : "25px"}} type="book" theme="outlined" /></div><h3 style={{color:"white",fontSize:"13px",weight:"25px"}}>DIARY</h3></div>
              <div style={{color:"white",textAlign:"center",}}><div style={{height : "80px" , width : "80px" , backgroundColor : "#E6B000" , display : "flex" , alignItems :"center" , justifyContent : "center" , borderRadius : "40px"}}><Icon style={{fontSize : "25px"}} type="car" theme="outlined" /></div><h3 style={{color:"white",fontSize:"13px",weight:"25px"}}>BUS</h3></div>
            </div>
            <div style={{height : "27.5vh" , width : "inherit" , display : "flex" , flexDirection : "row" , justifyContent : "space-around" , alignItems : "center"}}>
              <Link to='/calendar' >
              <div style={{color:"white",textAlign:"center",}}><div style={{height : "80px" , width : "80px" , backgroundColor : "#00A557" , display : "flex" , alignItems :"center" , justifyContent : "center" , borderRadius : "40px"}}><Icon style={{fontSize : "25px"}} type="bars" theme="outlined" /></div><h3 style={{color:"white",fontSize:"13px",weight:"25px"}}>CALENDER</h3></div>
              </Link>
          ...
          <div style={{height : "45vh", width : "360px", maxWidth : "90%" , backgroundColor : "#2B2082" , display : "flex" , justifyContent : "space-around" ,flexDirection : "column"}}>
            <div style={{height : "27.5vh" , width : "inherit" , display : "flex" , flexDirection : "row" , justifyContent : "space-around" , alignItems : "center"}}>
              ...
              <div style={{color:"white",textAlign:"center",}}><div style={{height : "80px" , width : "80px" , backgroundColor : "#FD0041" , display : "flex" , alignItems :"center" , justifyContent : "center" , borderRadius : "40px"}}><Icon style={{fontSize : "25px"}} type="fork" theme="outlined" /></div><h3 style={{color:"white",fontSize:"13px",weight:"25px"}}>LEAVES</h3></div>
              <div style={{color:"white",textAlign:"center",}}><div style={{height : "80px" , width : "80px" , backgroundColor : "#E6B000" , display : "flex" , alignItems :"center" , justifyContent : "center" , borderRadius : "40px"}}><Icon style={{fontSize : "25px"}} type="hdd" theme="outlined" /></div><h3 style={{color:"white",fontSize:"13px",weight:"25px"}}>LIBRARY</h3></div>
            </div>
            <div style={{height : "27.5vh" , width : "inherit" , display : "flex" , flexDirection : "row" , justifyContent : "space-around" , alignItems : "center"}}>
